 ...
 */
export type RegionId = "capital_kingdom" | "frostpeak_ridge" | "whistling_woods" | "sunstone_highlands" | "gloomwood_basin" | "emerald_coast";
export type SubregionId = "frostpeak_foothills" | "alpine_slopes" | "glacier_zone" | "mountain_valleys" | "ancient_canopy" | "forest_valley" | "western_woodland" | "river_forest" | "sandstone_plateau" | "basalt_crags" | "dry_basin" | "desert_approach" | "mistmire_marsh" | "swamp_forest" | "emerald_basin" | "southern_estuary" | "royal_palace_terrace" | "city_plateau" | "river_approach" | "sunblossom_meadows";
export type LandformKind = "alpine_ridge" | "mountain_peak" | "plateau_mesa" | "river_canyon" | "alluvial_valley" | "coastal_basin" | "wetland_delta";
export type ElevationZone = "subsea" | "lowland_marsh" | "river_valley" | "plateau" | "highland" | "alpine_crest";
...
export type LandmarkCategory = "citadel" | "ancient_ruin" | "natural_wonder" | "temple" | "bridge" | "outpost" | "sanctuary";
