import { Mountain, Trees, Droplets, Wind, CloudMoon, Castle, } from "lucide-react";
export const WORLD_REGIONS = [
    {
        ...
        teaser: "The heart of human ambition. White marble spires pierce the skies while grand cathedrals overlook prosperous markets.",
    ...
    },
    {
        ...
        teaser: "A graveyard of ancient stone and floating crimson crystals where dark magic still echoes through forgotten temples.",
    ...
    },
    {
        ...
        teaser: "Endless white plains under aurora-lit skies. Ancient ice entombs civilizations lost to time.",
    ...
    },
    {
        ...
        teaser: "Ancient groves where trees blot out the sun and druidic wardens guard secrets older than mankind.",
    ...
    },
    {
        ...
        teaser: "Bioluminescent abyss hiding sunken kingdoms. Strange life drifts through liquid night.",
    ...
    },
    {
        ...
        teaser: "Islands suspended by primordial magic. Each holds a fragment of ancient power.",
...
//# sourceMappingURL=worldRegions.js.map