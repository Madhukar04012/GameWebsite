...
const FRAGMENTS: Record<FireKind, string> = {
  torch: FRAGMENT_TORCH,
  magic: FRAGMENT_MAGIC,
  ember: FRAGMENT_EMBER,
};

const COLORS: Record<FireKind, { c1: number; c2: number; c3: number }> = {
...
export function createFireMaterial(opts: FireMaterialOptions = {}): THREE.ShaderMaterial {
