...
export function NPCRenderer() {
    ...
    if (count === 0)
        return null;
    return (_jsxs("instancedMesh", { ref: meshRef, args: [undefined, undefined, count], castShadow: true, receiveShadow: true, children: [_jsx("capsuleGeometry", { args: [0.4, 1.0, 4, 8] }), _jsx("meshStandardMaterial", { roughness: 0.8 })] }));
}
//# sourceMappingURL=NPCRenderer.js.map