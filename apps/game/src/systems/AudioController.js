...
function getNoiseBuffer(ctx, size = 4096) {
    if (_noiseBuffer)
        return _noiseBuffer;
...
/* ── Footstep ── */
function playFootstep(ctx, surface) {
 ...
 */
export function AudioController({ enabled = true }) {
    const soundsRef = useRef({ wind: null, rain: null, thunder: null, district: null });
